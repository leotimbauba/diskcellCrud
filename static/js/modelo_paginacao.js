document.addEventListener("DOMContentLoaded", function () {
  ...
  const tabela = document.getElementById("modelo-tabela");
  const linhas = Array.from(tabela.getElementsByClassName("modelo-item"));
  const paginacao = document.getElementById("modelo-paginacao");
