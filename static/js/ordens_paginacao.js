document.addEventListener("DOMContentLoaded", function () {
  ...
  const tabela = document.getElementById("ordem-tabela");
  const linhas = Array.from(tabela.getElementsByClassName("ordem-item"));
  const paginacao = document.getElementById("ordempaginacao");
